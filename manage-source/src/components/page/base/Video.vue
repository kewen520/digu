...
export default {
    ...
    methods: {
        ...
        //得到文件播放时长
        getFilePlayDuration(){
            return $.get(this.$baseUrl+'services/file/getFilePlayDuration.json?filePath='+this.soundPath).then((res)=>{
    ...
    watch:{
        source(src){
            ...
            // this.viewSource = src;
            this.soundPath = src;
            this.viewSource = this.$baseUrl+'services/file/downloadFile.html?filePath='+src;
            this.videoPlay = true;
