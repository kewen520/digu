    ...
    <div class="login-wrap log-form">
        <div class="login-left">
            ...
            <div class="logo-text">
                ...
                <!-- <span class="b">智能外呼系统<span></span>V Beta 1.0</span> -->
    ...
    export default {
        ...
        methods: {
            ...
            submitAjax(){
                ...
                $.post(this.$baseUrl+'member/loginByAccountName.json',JSON.stringify(data)).then((res)=>{
                    if(res.resultMessageEnum=='0000'){
                        ...
                        this.$store.dispatch('setUserInfoData',res.returnObject)
